    ...
    <div className="chat-container">
      ...
      <div className="messages-container">
        {chat ? (
          <>
            <div className="name-user">
              ...
              {user.role === "specialist" ? (
                <div className="activate-btn">
                  <button className={`${status}`} onClick={startChat}>
                    {changeTextButton(status)}
                  </button>
                </div>
              ) : null}
            </div>
            ...
            {status === "finished" && (
              <>
                ...
                {user.role === "pacient" && (
                  <p className="no-chat">
                    Recuerde darle un rating al especialista en su perfil
                  </p>
                )}
              </>
            )}
          ...
          <h3 className="no-chat">
            Haga clic en un usuario para iniciar la conversación
          </h3>
        )}
      </div>
    </div>
